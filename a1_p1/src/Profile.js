              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <div className="mt-3">
                      <h4>{window.localStorage.getItem("fName")}  {window.localStorage.getItem("lName")} </h4>
                      <p className="text-secondary mb-1">@{window.localStorage.getItem("uName")}</p>
                      <p className="text-muted font-size-sm">Bay Area, San Francisco, CA</p>
                      <div className="row">
                        <div className="col"><Follow name="Followers" /></div>
                        <div className="col"><Follow name="Following" /></div>
                      </div>
                ...
                <div className="card-body">
                  <div className="row">
                    ...
                    <div className="col-sm-9 text-secondary">
                      {window.localStorage.getItem("fName")}  {window.localStorage.getItem("lName")} 
                      {/* window.localStorage.setItem('fName', data.get('firstName')) */}
                    </div>
                  </div>
                  <hr/>
                  <div className="row">
